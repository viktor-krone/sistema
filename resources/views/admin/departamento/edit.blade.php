...
@section('breadcrumb')
  <li class="breadcrumb-item"><a href="{{route('admin.bodega.index')}}">Departamentos</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        class="form-control" type="text" name="nombre" id="nombre" value="{{ $departamento->nombre }} ">
                        <label for="slug">Slug</label>
                        <input readonly v-model="generarSLug"  class="form-control" type="text" name="slug" id="slug" value="{{ $departamento->slug }} ">
                        <div v-if="div_aparecer" v-bind:class="div_clase_slug">
                           @{{ div_mensajeslug }}
                        </div>
                        <br v-if="div_aparecer">
                        <label for="descripcion">Descripción</label>
                        <textarea class="form-control" name="descripcion" id="descripcion" cols="30" rows="5">  {{ $departamento->descripcion }}  </textarea>
