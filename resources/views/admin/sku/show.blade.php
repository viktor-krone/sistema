...
<form action="{{ route('admin.sku.update',$sku->id) }}" method="POST" enctype="multipart/form-data" >
@csrf
@method('PUT')
       ...
       <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                   ...
                   <a class="btn btn-outline-success" href="{{ route('admin.sku.edit',$sku->slug) }}">Editar</a>
