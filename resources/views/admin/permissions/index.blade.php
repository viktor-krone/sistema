  ...
  <div class="card-header py-3">
    <div class="row col-12">
      ...
      <div class="col-6">
        ...
        <a href="{{ route('admin.permissions.create') }}" class="btn btn-success btn-icon-split float-right">
            ...
            @foreach ($items as $index => $item)
              ...
              <tr>
                ...
                <td class="d-flex justify-content-center">
                    <a href="{{ route('admin.permissions.edit', ['permission' => $item->id, 'page' => $page]) }}" class="btn btn-info btn-circle btn-sm" title="Editar" style="margin:1px">
                      <span class="icon">
