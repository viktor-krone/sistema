...
<div id="apiempresa">
    <form action="{{ route('admin.empresa.update',$empresa->id)}}" method="POST" enctype="multipart/form-data">
      ...
      <span style="display:none;" id="rut_empresatemp">{{ $empresa->rut_empresa }}</span>
      <!-- Default box -->
      <div class="card">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              class="form-control" type="text" name="rut_empresa" id="rut_empresa" value="{{ $empresa->rut_empresa }}">
                              ...
                              <input class="form-control" type="text" name="razon" id="razon" value="{{ $empresa->razon }}">
                          </div>
                          <!-- /.form-group -->
                      </div>
                      <!-- /.col -->
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input  class="form-control" type="text" name="fantasia" id="fantasia" value="{{ $empresa->fantasia }}">
                  ...
                  <div class="row">
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>Region</label>
                              <div class="input-group">
                                  <input class="form-control" type="text" id="region" name="region" value="{{ $empresa->direccion }}">
                              </div>
                          </div>
                          <!-- /.form-group -->
                      </div>
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>Comuna</label>
                              <div class="input-group">
                                  <input class="form-control" type="text" id="comuna" name="comuna" value="{{ $empresa->comuna }}">
                              </div>
                          </div>
                          <!-- /.form-group -->
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  <input class="form-control" type="text" id="direccion" name="direccion" value="{{ $empresa->direccion }}">
                              </div>
                          </div>
                          <!-- /.form-group -->
                      </div>
