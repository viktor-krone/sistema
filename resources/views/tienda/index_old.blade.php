    ...
    <div class="products">
        <div class="container">
                ...
                <div class="col">
                    <div class="page_nav">
                        ...
                        <ul  class="d-flex flex-row align-items-start justify-content-center">
                            ...
                            <li
                            v-for="(categoria,i) in listaCategorias"
                            :key="i"
                            :class="{ active: i === 0}">
                                <a href="category.html"> @{{ categoria.nombre }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row products_row">
                ...
                <div v-for="(producto,i) in listaProductos"
                :key="i"
                :class="{ active: i === 0}"
                        ...
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                ...
                                <div class="ml-auto text-right">
                                    <div class="product_category">En <a href="category.html">Categoria</a></div>
...
<div class="lomasvendidocontenedor">
    ...
    <div class="lomasvendidocontenedor">
        ...
        <div class="lomasvendido owl-carousel owl-theme">
            ...
            <!-- item-->
            <div v-for="(producto,i) in listaProductos" class="">
                <div class="product">
                    <div v-if="producto.estado == 'Nuevo'">
                        <span class="badge-new">
                            <b> @{{ producto.estado }}</b>
                        </span>
                    </div>
                    <div v-if="producto.estado == 'En Oferta'">
                        <span class="badge-offer">
                            <b> @{{ producto.porcentaje_descuento }}%</b>
                        </span>
                    </div>
                    ...
                    <div class="product_content">
                        <div class="product_info">
                            <div>
                                <div>
                                    <div class="product_name product_namesinwidth text-center">
